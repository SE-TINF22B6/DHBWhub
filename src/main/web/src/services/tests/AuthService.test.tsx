...
//
//             expect(currentUserAccountId).toEqual(userAccountIdString);
//         });
//
...
//
//             expect(currentUserId).toEqual(userIdString);
//         });
//
...
//
//             const currentUserUsername = authService.getAccountId();
//
...
//
//             const currentUserJWTToken = authService.getAccountId();
//
