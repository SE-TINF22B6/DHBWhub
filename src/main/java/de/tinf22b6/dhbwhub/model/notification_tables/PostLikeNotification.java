...
public class PostLikeNotification {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "post_like_notification_generator")
    @SequenceGenerator(name = "post_like_notification_generator", sequenceName = "post_like_notification_seq", allocationSize = 1)
